...
const Skills = () => {
  return (
    <>
      <Header />
      <div name='skills' className='w-full min-h-screen bg-[#040404] text-gray-300' id='services'>
        <div className='max-w-[1000px] mx-auto p-4'>
          ...
          <div className='grid grid-cols-2 sm:grid-cols-4 gap-5 text-center py-11'>
            ...
            {/* Redux ToolKit */}
            <div className='w-40 hover:scale-110 duration-500'>
              <img className='w-20 mx-auto' src='https://w7.pngwing.com/pngs/332/110/png-transparent-logo-brand-logo-brand-react-3d-icon.png' alt='Redux icon' />
            ...
            {/* Git */}
            <div className='w-40 hover:scale-110 duration-500'>
              <img className='w-20 mx-auto' src='https://cdn3d.iconscout.com/3d/free/thumb/free-git-9294878-7578021.png?f=webp' alt='Git icon' />
            ...
            {/* Package */}
            <div className='w-40 hover:scale-110 duration-500'>
              <img className='w-20 mx-auto' src='https://cdn3d.iconscout.com/3d/free/thumb/free-npm-9294882-7578025.png?f=webp' alt='NPM icon' />
              <p className='my-4'>Package</p>
            </div>
            {/* Auth 0 */}
            <div className='w-40 hover:scale-110 duration-500'>
              <img className='w-20 mx-auto' src='https://seeklogo.com/images/A/auth0-logo-03B0DBA304-seeklogo.com.png' alt='Auth0 icon' />
              <p className='my-4'>Auth 0</p>
            </div>
            {/* Firebase */}
            <div className='w-40 hover:scale-110 duration-500'>
              <img className='w-20 mx-auto' src='https://cdn.iconscout.com/icon/free/png-256/free-firebase-3521427-2944871.png?f=webp' alt='Firebase icon' />
              <p className='my-4'>Firebase</p>
            </div>
            {/* AWS */}
            <div className='w-40 hover:scale-110 duration-500'>
              <img className='w-20 mx-auto' src='https://cdn3d.iconscout.com/3d/free/thumb/free-amazon-web-services-8074662-6507782.png?f=webp' alt='AWS icon' />
